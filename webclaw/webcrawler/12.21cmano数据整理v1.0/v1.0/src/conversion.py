...
if __name__ == '__main__':
    ...
    # 写入json文件
    if base_dir == "../source/原版":
        with open('../data/原版转格式(V1.0)' + str(count) + '.json', 'w', encoding='utf-8') as f:
            json.dump(result, f, indent=4, ensure_ascii=False)
    elif base_dir == "../source/冷战":
        with open('../data/冷战转格式(V1.0)' + str(count) + '.json', 'w', encoding='utf-8') as f:
            json.dump(result, f, indent=4, ensure_ascii=False)
